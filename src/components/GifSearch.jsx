  ...
  return (
    <div className="flex relative">
      <input
        ...
        placeholder="Search for all Gifs and Stickers"
        className="w-full pl-4 pr-14 py-5 text-xl text-black bg-white rounded-tl rounded-bl border border-gray-300 outline-none"
      />
